  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-navy elevation-4">
      ...
      <a href="main.php?view=home" class="brand-link">
        <img src="images/perfil2.jpg" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-bold">Sistema de Farmacia</span>
      </a>
    ...
    <footer class="main-footer text-sm">
      <strong>Copyright &copy; 2022 <a href="https://www.facebook.com/LuisAndersonRamosWR">Sistema de Farmacia</a>.</strong>
    </footer>
  </div>
  <!-- ./wrapper -->
